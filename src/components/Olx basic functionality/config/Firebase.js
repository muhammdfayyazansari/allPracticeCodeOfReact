...
const sendProductData = async (product, userUID) => {
  let finalProduct = {...product, image: "https://www.bugatti.com/fileadmin/_processed_/sei/p121/se-image-4f750982624e527a8b1003408e4febcf.jpg", uid: userUID}
  try{
...
export { createUser, logInUser, getUserDataFromFirebase, auth, latestFormData , sendProductData, getProductsData};
