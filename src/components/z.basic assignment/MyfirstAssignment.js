...
//           {/* {
//             <thead><th><h1>COMPANY</h1></th> <th><h1>JOBS</h1></th></thead>
//           } */}
//            <thead>
//               {Object.keys(complex[0]).map((item,index)=> {<th key={index}><h1>{item}</h1></th>})}
//             </thead>
//           {complex.map((item,index)=>{
//           return <tr><td><h1>{item.company}</h1></td>
//           <td><h1>{item.jobs.map((jobs,index)=>{
//           return <span style={{paddingRight: "10px"}}>{jobs}</span>
//         })}</h1></td>
//           </tr>
//           })}
